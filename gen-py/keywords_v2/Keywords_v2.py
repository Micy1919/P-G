...
class Client(Iface):
    ...
    def recv_find_keywords(self):
        ...
        raise TApplicationException(TApplicationException.MISSING_RESULT, "find_keywords failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {}
        self._processMap["find_keywords"] = Processor.process_find_keywords
    ...
    def process_find_keywords(self, seqid, iprot, oprot):
        args = find_keywords_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = find_keywords_result()
        ...
        oprot.writeMessageBegin("find_keywords", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class find_keywords_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, (self.__class__, self.thrift_spec)))
            return
        oprot.writeStructBegin('find_keywords_result')
