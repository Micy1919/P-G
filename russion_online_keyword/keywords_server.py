...
from core.preconditioning.pre_process_ru import PreProcess
...
class Keywords(CandidateKeyword):
    ...
    def __init__(self,PUN_FILE=None, STOP_FILE=None, COMMON_WORDS_FILE=None, SPECIAL_FILE=None,lan=None):
        ##配置基本属性
        ru_tool = PreProcess(PUN_FILE,STOP_FILE)
        self.nlp = ru_tool
        self.language_stem = ru_tool
        self.idf = EnIDF()
        self.textrank = None
        self.language = lan
